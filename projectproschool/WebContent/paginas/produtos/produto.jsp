						...
						<div class="table-responsive col-lg-12">
							<table class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<logic:iterate id="produtoCorrente" indexId="i" name="produtoForm" property="produtos" type="br.com.srcsoftware.projectproschool.sistema.produto.model.ProdutoPO">
										<tr>
