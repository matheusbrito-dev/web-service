						...
						<div class="table-responsive col-lg-12">
							<table class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<logic:iterate id="formaPagamentoCorrente" indexId="i" name="formaPagamentoForm" property="formaPagamentos" type="br.com.srcsoftware.projectproschool.sistema.financeiro.formapagamento.model.FormaPagamentoPO">
										<tr>
