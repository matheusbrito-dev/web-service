						...
						<div class="table-responsive col-lg-12">
							<table class="table table-striped table-bordered table-hover">
								...
								<tbody>
									...
									<logic:iterate id="clienteCorrente" indexId="i" name="clienteForm" property="clientes" type="br.com.srcsoftware.efinanceiro.sistema.pessoa.cliente.model.ClientePO">
										<tr>
